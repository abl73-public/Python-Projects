...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_studenttracking (col_fname,col_lname,col_fullname,col_phone,col_email,col_course) VALUES (?,?,?,?,?,?)""", ('Bob','Childe','Bob Childe','111-111-1111','bochd@email.com','Computer Science'))
            conn.commit()
    conn.close()
